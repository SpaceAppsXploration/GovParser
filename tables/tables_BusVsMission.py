...
deep_space_obs = {}
deep_space_obs['name'] = 'Space observation'
deep_space_obs['slug'] = 'space_obs'
deep_space_obs['therm_active'] = True
deep_space_obs['therm_passive'] = True
deep_space_obs['pow_prim_panels'] = True
deep_space_obs['pow_prim_rtg'] = True
deep_space_obs['pow_sec_batt'] = True
deep_space_obs['pow_sec_fc'] = True
deep_space_obs['comm_mono'] = True
deep_space_obs['comm_omni'] = True
deep_space_obs['aodcs_robust'] = True
deep_space_obs['aodcs_simple'] = True
deep_space_obs['prop_electr'] = True
deep_space_obs['prop_chem'] = True
deep_space_obs['cdh_standard'] = True
deep_space_obs['cdh_optim'] = True
deep_space_obs['struct_stand'] = True
deep_space_obs['struct_high_resist'] = True

bus_vs_mission_type.append(deep_space_obs)
