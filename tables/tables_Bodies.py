...
saturn['atm_analysis'] = (False, 'You could, but once you land it is nearly impossible to go back due to gravity.')
...
beyond['sample_collect'] = (False, 'Wanna collect space dust?')
...
kbos = {}
kbos['name'] = 'Kuiber Belt and on'
kbos['slug'] = 'kbos'
kbos['distance'] = 45
kbos['earth_obs'] = False
...
kbos['atm_analysis'] = (False, 'NOT EVEN Think about!!! No place in space for such ignorance (:')
kbos['sample_collect'] = (False, 'NOT EVEN Think about!!! No place in space for such ignorance (:')
...
dwarf['atm_analysis'] = (False, 'NOT EVEN Think about!!! No place in space for such ignorance (:')
dwarf['sample_collect'] = (False, 'NOT EVEN Think about!!! No place in space for such ignorance (:')
